      ...
      <div className="space-y-5 text-center">
        <div className="flex flex-wrap items-center justify-center gap-3">
          <div className="group relative">
            <div className="from-pdd-purple to-pdd-blue absolute -inset-0.5 rounded-full bg-gradient-to-r opacity-75 blur-sm transition-opacity duration-300 group-hover:opacity-100"></div>
            <span className="from-pdd-purple to-pdd-blue relative flex items-center rounded-full bg-gradient-to-r px-5 py-2.5 text-sm leading-none font-bold text-white shadow-lg transition-all duration-300 group-hover:scale-105">
              Coming Soon
            </span>
          </div>
        ...
        <h1 className="text-4xl leading-tight font-bold md:text-6xl">
          <span className="from-pdd-purple to-pdd-blue bg-gradient-to-r bg-clip-text text-transparent">
            Palu Developer Day
          </span>
          <br />
        ...
        <div className="flex flex-col items-center gap-6 px-5 pt-12">
          <div className="relative">
            <div className="from-pdd-purple/20 to-pdd-blue/20 absolute inset-0 rounded-2xl bg-gradient-to-r blur-2xl" />

            <div className="relative flex flex-col items-center gap-5 rounded-2xl border border-white/20 bg-gradient-to-br from-white/10 to-white/5 p-5 backdrop-blur-sm md:p-7">
              <Link
